...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ErrorResponse> handleMethodArgumentNotValidException(
    ...
    ErrorResponse errorResponse =
        new ErrorResponse(
            Instant.now(), code.value(), "Validation failed", fieldsErrors.toString());
  ...
  public ResponseEntity<ErrorResponse> handleRuntimeException(RuntimeException ex) {
    ...
    ErrorResponse errorResponse =
        new ErrorResponse(Instant.now(), code.value(), "Internal Server Error", ex.getMessage());
  ...
  public ResponseEntity<ErrorResponse> handleObjectNotFoundException(RuntimeException ex) {
    ErrorResponse error =
        new ErrorResponse(
            Instant.now(), HttpStatus.NOT_FOUND.value(), "Object not found", ex.getMessage());
  ...
  public ResponseEntity<ErrorResponse> handleAccessDeniedException(AccessDeniedException ex) {
    ...
    HttpStatus code = HttpStatus.FORBIDDEN; // 403
